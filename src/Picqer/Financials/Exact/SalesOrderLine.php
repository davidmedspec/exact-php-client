 ...
 * @property Guid $GLAccount The GL Account of the sales order line. This field is mandatory. This field is generated based on the revenue account of the item (or the related item group). G/L Account is also used to determine whether the costcenter / costunit is mandatory
 ...
 * @property Int32 $LineNumber Indicates the sequence of the lines within one order
 ...
 * @property Guid $Subscription Obsolete. When generating orders from subscriptions, this field records the link between order lines and subscription lines
 ...
 * @property String $VATCode The VAT code that is used when the order is registered
 * @property String $VATCodeDescription Description of VATCode
 * @property Double $VATPercentage The vat percentage of the VAT code. This is the percentage at the moment the order is created. It's also used for the default calculation of VAT amounts and VAT base amounts
 */
